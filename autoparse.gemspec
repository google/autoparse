...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/autoparse", "lib/autoparse/inflection.rb", "lib/autoparse/instance.rb", "lib/autoparse/version.rb", "lib/autoparse.rb", "spec/autoparse", "spec/autoparse/instance_spec.rb", "spec/data", "spec/data/account.json", "spec/data/address.json", "spec/data/adult.json", "spec/data/calendar.json", "spec/data/card.json", "spec/data/geo.json", "spec/data/hyper-schema.json", "spec/data/interfaces.json", "spec/data/json-ref.json", "spec/data/links.json", "spec/data/node.json", "spec/data/person.json", "spec/data/positive.json", "spec/data/schema.json", "spec/data/user-list.json", "spec/spec.opts", "spec/spec_helper.rb", "tasks/clobber.rake", "tasks/gem.rake", "tasks/git.rake", "tasks/metrics.rake", "tasks/rdoc.rake", "tasks/spec.rake", "tasks/yard.rake", "website/index.html", "CHANGELOG.md", "LICENSE", "Rakefile", "README.md"]
